    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '40px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <section style={{ textAlign: 'center', padding: '30px 16px 20px 16px', borderBottom: '1px solid var(--border-color)' }}>
        <div style={{
          ...
          border: '1px solid rgba(245, 158, 11, 0.3)', padding: '6px 18px',
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.6rem', fontWeight: '900', color: '#f59e0b' }}>2013</div>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontSize: '1.6rem', fontWeight: '900', color: '#10b981' }}>100% Verified</div>
          ...
          <div style={{ position: 'relative', flexShrink: 0 }}>
            {adminPhoto ? (
              ...
              <div style={{
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center',
                fontSize: '3rem', fontWeight: '900', border: '5px solid #10b981',
                boxShadow: '0 8px 24px rgba(16, 185, 129, 0.35)',
                aspectRatio: '1/1'
              }}>
                KD
