              ...
              <div className="card-body">
                {!img2PdfResult ? (
                  ...
                  <div style={{ textAlign: 'center', padding: '24px' }}>
                    ...
                    <a href={getFullUrl(img2PdfResult.downloadUrl)} download={img2PdfResult.result.fileName} className="btn btn-primary btn-lg">
              ...
              <div className="card-body">
                {!mergeResult ? (
                  ...
                  <div style={{ textAlign: 'center', padding: '24px' }}>
                    ...
                    <a href={getFullUrl(mergeResult.downloadUrl)} download={mergeResult.result.fileName} className="btn btn-primary btn-lg">
              ...
              <div className="card-body">
                {!splitResult ? (
                  ...
                  <div style={{ textAlign: 'center', padding: '24px' }}>
                    ...
                    <a href={getFullUrl(splitResult.downloadUrl)} download={splitResult.result.fileName} className="btn btn-primary btn-lg">
              ...
              <div className="card-body">
                {!rotateResult ? (
                  ...
                  <div style={{ textAlign: 'center', padding: '24px' }}>
                    ...
                    <a href={getFullUrl(rotateResult.downloadUrl)} download={rotateResult.result.fileName} className="btn btn-primary btn-lg" style={{ marginTop: '16px' }}>
              ...
              <div className="card-body">
                {!compResult ? (
                  ...
                  <div style={{ textAlign: 'center', padding: '24px' }}>
                    ...
                    <a href={getFullUrl(compResult.downloadUrl)} download={compResult.result.fileName} className="btn btn-primary btn-lg">
