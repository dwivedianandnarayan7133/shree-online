...
export const api = {
  ...
  sendSmsOtp: (data) => request('/auth/send-sms-otp', { method: 'POST', body: data }),
  verifySmsOtp: (data) => request('/auth/verify-sms-otp', { method: 'POST', body: data }),
  ...
  getFileUrl: (requestId, fileId) => `${API_BASE}/requests/${requestId}/file/${fileId}`,
